...
void vat(){
	...
	(*write)<<setprecision(20)<<v.income<<" "<<setprecision(20)<<v.tax<<" "<<setprecision(20)<<v.lastincome<<" "<<endl;
...
void propertyTax(){
	...
	if(p.op == 'r'){
		...
		(*write)<<setprecision(20)<<p.sale<<" "<<setprecision(20)<<p.tax<<" "<<setprecision(20)<<p.afterpay<<" "<<endl;
